        ...
        try (Connection connection = DatabaseConnection.getConnection(); Statement statement = connection.createStatement()) {
            ...
            if (isTableEmpty("Users") && isTableEmpty("Books")) {
                ...
                String insertBorrows = "INSERT INTO Borrows (member_id, book_isbn, borrow_date, due_date, return_date, status, fine, created_by, created_at) VALUES " +
                        ...
                        "(1, 9780201633610, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP)," +
                        "(2, 9780201485677, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP)," +
                        "(3, 9780735619678, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP)," +
                        "(1, 9780262033848, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP)," +
                        "(4, 9780321349606, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP)," +
                        "(2, 9780201835953, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP)," +
                        "(1, 9781491904244, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL 14 DAY, NULL, 'BORROWED', 0, 'admin@example.com', CURRENT_TIMESTAMP);";
