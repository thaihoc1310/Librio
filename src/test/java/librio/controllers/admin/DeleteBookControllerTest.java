...
public class DeleteBookControllerTest {
    ...
    @Test
    public void testDeleteBookWhenBookIsCurrentlyBorrowed() throws Exception {
    ...
    @Test
    public void testDeleteBookWhenBookIsNull() throws Exception {
    ...
    private void simulateExceptionOnDeleteBook(Exception exception) throws Exception {
